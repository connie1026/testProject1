...
+(CCSprite*)coinsInit {
    ...
    coins.physicsBody.collisionType = @"coinsCollision";
    coins.name = @"coins";
...
+(CCSprite*)bluediamondInit {
    ...
    bluediamond.physicsBody.collisionType = @"bluediamondCollision";
...
+(CCSprite*)LineShapeStars {
    ...
    CCSprite *obj0 = [Rewards bluediamondInit];
    ...
    CCSprite *obj8 = [Rewards bluediamondInit];
    ...
    obj0.position = ccp(obj0.position.x, 20);
    obj1.position = ccp(obj0.position.x + obj1.contentSize.width*3.5, 20);
    obj2.position = ccp(obj1.position.x + obj2.contentSize.width*3.5, 20);
    obj3.position = ccp(obj2.position.x + obj3.contentSize.width*3.5, 20);
    obj4.position = ccp(obj3.position.x + obj4.contentSize.width*3.5, 20);
    obj5.position = ccp(obj4.position.x + obj5.contentSize.width*3.5, 20);
    obj6.position = ccp(obj5.position.x + obj6.contentSize.width*3.5, 20);
    obj7.position = ccp(obj6.position.x + obj7.contentSize.width*3.5, 20);
    obj8.position = ccp(obj7.position.x + obj8.contentSize.width*3.5, 20);
...
+(CCSprite*)RectShapeStars {
    ...
    CCSprite *obj0 = [Rewards bluediamondInit];
    CCSprite *obj1 = [Rewards bluediamondInit];
    CCSprite *obj2 = [Rewards starInit];
    CCSprite *obj3 = [Rewards bluediamondInit];
    CCSprite *obj4 = [Rewards bluediamondInit];
    CCSprite *obj5 = [Rewards starInit];
    CCSprite *obj6 = [Rewards bluediamondInit];
    CCSprite *obj7 = [Rewards bluediamondInit];
    CCSprite *obj8 = [Rewards starInit];
    //CCSprite *obj9 = [Rewards bluediamondInit];
    //CCSprite *obj10 = [Rewards bluediamondInit];
    //CCSprite *obj11 = [Rewards starInit];
    ...
    obj1.position = ccp(obj0.position.x + obj1.contentSize.width*3.5, 15);
    obj2.position = ccp(obj1.position.x + obj2.contentSize.width*3.5, 15);
    obj3.position = ccp(obj2.position.x + obj3.contentSize.width*3.5, 35);
    obj4.position = ccp(obj3.position.x + obj4.contentSize.width*3.5, 35);
    obj5.position = ccp(obj4.position.x + obj5.contentSize.width*3.5, 35);
    obj6.position = ccp(obj5.position.x + obj6.contentSize.width*3.5, 55);
    obj7.position = ccp(obj6.position.x + obj7.contentSize.width*3.5, 55);
    obj8.position = ccp(obj7.position.x + obj8.contentSize.width*3.5, 55);
    //obj9.position = ccp(obj8.position.x + obj9.contentSize.width*3.5, 55);
    //obj10.position = ccp(obj9.position.x + obj10.contentSize.width*3.5, 55);
    //obj11.position = ccp(obj10.position.x + obj11.contentSize.width*3.5, 55);
...
+(CCSprite*)DiamondShapeStars {
    ...
    CCSprite *obj0 = [Rewards bluediamondInit];
    CCSprite *obj1 = [Rewards starInit];
    CCSprite *obj2 = [Rewards bluediamondInit];
    CCSprite *obj3 = [Rewards bluediamondInit];
    CCSprite *obj4 = [Rewards starInit];
    CCSprite *obj5 = [Rewards bluediamondInit];
    CCSprite *obj6 = [Rewards bluediamondInit];
    CCSprite *obj7 = [Rewards starInit];
    CCSprite *obj8 = [Rewards bluediamondInit];
    //CCSprite *obj9 = [Rewards bluediamondInit];
    //CCSprite *obj10 = [Rewards bluediamondInit];
    //CCSprite *obj11 = [Rewards starInit];
    
    obj0.position = ccp(obj0.position.x, 40);
    obj1.position = ccp(obj0.position.x + obj1.contentSize.width*3.5, 40);
    obj2.position = ccp(obj1.position.x + obj2.contentSize.width*3.5, 40);
    obj3.position = ccp(obj2.position.x + obj3.contentSize.width*3.5, 20);
    obj4.position = ccp(obj3.position.x + obj4.contentSize.width*3.5, 20);
    obj5.position = ccp(obj4.position.x + obj5.contentSize.width*3.5, 20);
    obj6.position = ccp(obj5.position.x + obj6.contentSize.width*3.5, 40);
    obj7.position = ccp(obj6.position.x + obj7.contentSize.width*3.5, 40);
    obj8.position = ccp(obj7.position.x + obj8.contentSize.width*3.5, 40);
    //obj9.position = ccp(obj8.position.x + obj9.contentSize.width*3.5, 40);
    //obj10.position = ccp(obj9.position.x + obj10.contentSize.width*3.5, 40);
    //obj11.position = ccp(obj10.position.x + obj11.contentSize.width*3.5, 40);
...
+(CCSprite*)HeartShapeStars{
    ...
    obj0.position = ccp(obj0.position.x, 45);
    obj1.position = ccp(obj0.position.x + obj1.contentSize.width*4.5, 25);
    obj2.position = ccp(obj1.position.x + obj2.contentSize.width*4.5, 45);
    obj3.position = ccp(obj2.position.x + obj3.contentSize.width*4.5, 25);
    obj4.position = ccp(obj3.position.x + obj4.contentSize.width*4.5, 45);
    obj5.position = ccp(obj4.position.x + obj5.contentSize.width*4.5, 25);
    obj6.position = ccp(obj5.position.x + obj6.contentSize.width*4.5, 45);
    obj7.position = ccp(obj6.position.x + obj7.contentSize.width*4.5, 25);
    obj8.position = ccp(obj7.position.x + obj8.contentSize.width*4.5, 45);
    //obj9.position = ccp(obj8.position.x + obj9.contentSize.width*4.5, 25);
    //obj10.position = ccp(obj9.position.x + obj10.contentSize.width*4.5, 45);
    //obj11.position = ccp(obj10.position.x + obj11.contentSize.width*4.5, 25);
...
+(CCSprite*)StarAndBlueDiamon{
    ...
    //spr1.position = ccp(spr0.contentSize.width + 50, 10);
    //spr2.position = ccp(spr1.position.x + spr1.contentSize.width + 50 + spr2.contentSize.width, 0);
    obj0.position = ccp(obj0.position.x, 30);
    obj1.position = ccp(obj0.position.x + obj1.contentSize.width*3.5, 30);
    obj2.position = ccp(obj1.position.x + obj2.contentSize.width*3.5, 30);
    obj3.position = ccp(obj2.position.x + obj3.contentSize.width*3.5, 30);
    obj4.position = ccp(obj3.position.x + obj4.contentSize.width*3.5, 30);
    obj5.position = ccp(obj4.position.x + obj5.contentSize.width*3.5, 30);
    obj6.position = ccp(obj5.position.x + obj6.contentSize.width*3.5, 30);
    obj7.position = ccp(obj6.position.x + obj7.contentSize.width*3.5, 30);
    obj8.position = ccp(obj7.position.x + obj8.contentSize.width*3.5, 30);
